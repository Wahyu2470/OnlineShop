      ...
      <section class="slider">
        <div class="flexslider">          
          <ul class="slides">
             <!-- login -->
    <div class="w3_login">
      <h3> Create Akun Toko Dora</h3>
        <div class="w3_login_module">
        <div class="module form-module">
          <div class="toggle"><i class="fa fa-times fa-pencil"></i>
          </div>
          <div class="form">
          <h2>Isi Data Diri Pelanggan</h2>
          <form action="" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="notlpn" class="form-control" placeholder="Masukkan Nomor Telepon Anda" />              
                </div>
                <div class="form-group">
                ...
                if (isset($_POST["simpan"])) 
{
        ...
        $koneksi->query("INSERT INTO pelanggan (nama,email,notlpn,alamat,username,password) values('$nama','$email','$notlpn','$alamat','$username','$pass')") or die (mysqli_error());
