...
<?php require_once("koneksi.php");
    include('config/cekpelanggan.php')
    ;?>    
					...
					<div class="mega-dropdown-menu">
						<div class="w3ls_vegetables">
							<ul class="dropdown-menu drp-mnu">
								<li><a a href="profile.php"> <?php $akun = $_SESSION['pelanggan'];?> <?php echo $_SESSION["pelanggan"]['nama'];?></a></li>
	...
	<div class="logo_products">
		<div class="container">
			<div class="w3ls_logo_products_left">
				<h1><a href="pelanggan.php"><span><img src="asset/images/toko3.jpg"></span></a></h1>
			</div>
...
<!-- products-breadcrumb -->
	<div class="products-breadcrumb">
		<div class="container">
			<ul>
				<li><i class="fa fa-home" aria-hidden="true"></i><a href="pelanggan.php">Home</a><span>|</span></li>
				<li>Selamat Datang di Toko Online Alphatech</li>
			</ul>
		</div>
	</div>
<!-- //products-breadcrumb -->
			   ...
			   <!-- Collect the nav links, forms, and other content for toggling -->
				<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
					<ul class="nav navbar-nav nav_1">
						<li></i> <a href="pelanggan.php"> Home</a></li>
								...
								<figure>
									<div class="snipcart-item block" >
										...
										<div class="snipcart-details top_brand_home_details">
												...
												<a href="beli.php?id=<?php echo $data['br_id'];?>" name="simpan" value="Simpan" class="btn btn-primary">Beli &raquo;</a>
												</fieldset>
										</div>
									</div>
								</figure>
