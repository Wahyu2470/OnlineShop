...
session_start();
$br_id = $_GET["id"];
$ambil = $koneksi->query("SELECT *FROM makanan WHERE br_id = $br_id");
					...
					<div class="mega-dropdown-menu">
						<div class="w3ls_vegetables">
							<ul class="dropdown-menu drp-mnu">
								<li><a> <?php $akun = $_SESSION['customer'];?> <?php echo $_SESSION["customer"]['nama'];?></a></li>
...
<div class="col-sm-6">
                    <?php                  
$query = mysqli_query($koneksi, "SELECT * FROM makanan WHERE br_id='$_GET[id]'");
...
?>
        		<!--<div class="span4">-->
                    ...
                    <tr>
                        ...
                        <td>Stock</td>
                        <td>:</td>
                        <td><div><?php echo $data['br_stok'];?></div></td>
                        </tr>
                        <tr>
                        <td></td>
                        <td>Satuan</td>
                        ...
                        <td>Berat</td>
                        <td>:</td>
                        <td><div><?php echo number_format($data['br_berat']); ?>.Gr</div></td>
                        </tr>
                        <tr>
                        <td></td>
                        <td>Keterangan</td>
                    ...
                    <form method="post">
                        ...
                        if (isset($_POST["beli"]))
                        	{
                        		$jumlah = $_POST["jumlah"];
                        		$_SESSION['keranjang'][$br_id] = $jumlah;
