...
Collect the nav links, forms, and other content for toggling
  ...
  <div class="container">
			...
			<!-- start: Table -->
                 ...
                 <div class="title"><h3>Riwayat Pembelian  <?php echo $_SESSION["pelanggan"]['nama']?></h3></div>
                ...
                <tbody>
                    <?php $nomor=1; ?>
                    	<?php 
                            ...
                            $sql = $koneksi->query("SELECT *FROM pembelian WHERE id_pelanggan='$id_pelanggan'"); 
                    ...
                    <tr>
                    	...
                    	<td>
                    		...
                    		<br>
                    		<?php if (!empty($data['nomor_resi'])): ?>
                    		Resi : <?php echo $data['nomor_resi'];?>
                    		<?php endif ?>
                    		</td>
                    	...
                    	<td>
                    		...
                    		<a href="pembayaran.php?id=<?php echo $data["id_pembelian"];?>" class="btn btn-success">Input Pembayaran</a>
                    		<?php else :?>
                    		<a href="lihat_pembayaran.php?id=<?php echo $data["id_pembelian"];?>" class="btn btn-warning">Lihat Pembayaran</a>
