     ...
     <div class="panel-body">
                ...
                <tbody>
                    ...
                    <tr>
                    	...
                    	<td>
                    		<a href="tambah_keranjang.php?act=plus&amp;id=<?php echo $data['br_id'];?>" class="btn btn-primary btn-xs">+</a> <?php echo $jumlah;?> <a href="tambah_keranjang.php?act=min&amp;id=<?php echo $data['br_id']; ?>" class="btn btn-primary btn-xs">-</a>
                    				
                    	</td>
                    	<td><?php echo number_format($subberat);?>.Gr</td>
                    	<td>Rp. <?php echo number_format($subtotal);?></td>
                    	<td><a href="hapuskeranjang.php?id=<?php echo $br_id?>" class="btn btn-danger btn-xs">hapus</td>
                    </tr>
                <?php $nomor++ ?>
                <?php endforeach ?>
                </tbody>
            </table>
            <a href="pelanggan.php" class="btn btn-default">Lanjutkan Belanja</a>
