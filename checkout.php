	...
	<div class="logo_products">
		<div class="container">
			<div class="w3ls_logo_products_left">
				<h1><a href="index.php"><span><img src="asset/images/Toko1.jpg"></span></a></h1>
			</div>
...
Collect the nav links, forms, and other content for toggling
  ...
  <div class="container">
    ...
    <tr>
        ...
        <td><input type="text" readonly value="<?php $nama = $_SESSION['username'];?> <?php echo $_SESSION['nama'];?>" size="50" /> </td>
      </tr>
      <tr>
        <td><label for="pengiriman">Pengiriman</label></td>
        <td><select name="id_ongkir" class="required">
        ...
        <option value="<?php echo $data["id_ongkir"]?>">
        	...
        	<?php echo $data['jenis_pengiriman']?>
    ...
    <?php }?>
       ...
       <tr>
        ...
        <td><select name="id_bank" class="required">
     ...
     <?php if (isset($_POST["checkout"])) 
     	{
     		...
     		$kode_pembayaran = $data_bank['kode_pembayaran'];

     		$query = mysqli_query($koneksi, "SELECT * FROM pengiriman where id_ongkir='$id_ongkir'");
		...
		$koneksi->query("INSERT INTO pembelian (nama,id_ongkir,nama_kota,jenis_pengiriman,tarif,id_bank,nama_bank, kode_pembayaran,tanggal_pembelian,total_pembelian) values('$nama','$id_ongkir','$nama_kota','$jenis_pengiriman','$tarif','$id_bank','$nama_bank','$kode_pembayaran','$tanggal_pembelian','$total_pembelian')");
