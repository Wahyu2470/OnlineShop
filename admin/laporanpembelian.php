  ...
  <div align="center">
    ...
    <table width="856" border="1" cellpadding="0" cellspacing="0">
      <tr bgcolor="#006600">
        ...
        <td width="110"><div align="center" class="style3">Nama Produk</div></td>
        <td width="55"><div align="center" class="style3">Harga</div></td>
        <td width="55"><div align="center" class="style3">Jumlah </div></td>
        <td width="180"><div align="center" class="style3">Alamat</div></td>
        <td width="80"><div align="center" class="style3"> Pengiriman</div></td>
        <td width="100"><div align="center" class="style3">Tarif</div></td>
        <td width="180"><div align="center" class="style3">Tanggal Pembelian</div></td>
        <td width="180"><div align="center" class="style3">Total Pembelian</div></td>
      </tr>
      </tr>
...
INNER JOIN pembelian ON pembelian_barang.id_pembelian = pembelian.id_pembelian")or die(mysqli_error());
