...
<!-- about -->
		<div class="privacy about">
			<h3>About Us</h3>
			<p class="animi"> 
				"Toko Dora" Adalah Aplikasi Toko online, yang dibuat menggunakan Bahasa Pemrograman PHP dan MySQL sebagai database..
				Dengan adanya Toko Online ini akan memudahkan Pelanggan bertransaksi, dan pengolahan data bagi administrator untuk melihat persediaan barang dan memantau alur transaksi serta mengolah data barang, seperti Inpu data, Mengubah data, menghapus data..
			</p>
		...
		<div class="container">
			...
			<div class="agileits_team_grids">
				<div class="col-md-3 agileits_team_grid">
					<img src="asset/kontak/Nata.jpeg" alt=" " class="img-responsive" />
					<h4> Shinta Wahyu</h4>
					<p>Desainer</p>
